...
namespace AerodynamicObjects
{
            ...
            private float NormalizeAngle(float angle)
    {
        ...
        var maxAngle = 20;
                         ...
                         Vector3 rotation = arrowTransforms[i].eulerAngles;
                        ...
                        arrowMaterials[i].color = gradientColor;
                ...
                else
                {
                    for (int i = 0; i < arrowTransforms.Length; i++)
                    {
                        ...
                        var angle = arrowTransforms[i].rotation.x + arrowTransforms[i].rotation.z;
                        var ceva = 90/ angle;
                        color = new Color(255 / ceva , 255 / (1- ceva), 0);
                        arrowMaterials[i].color = color;
                    }
                }
            }
            else
        ...
        void CreateArrows()
        {
            ...
            meshes = new MeshRenderer[numArrows.x * numArrows.y * numArrows.z];
            ...
            for (int x = 0; x < numArrows.x; x++)
            {
                for (int y = 0; y < numArrows.y; y++)
                {
                    for (int z = 0; z < numArrows.z; z++)
                    {
                        ...
                        meshes[count] = go.GetComponent<MeshRenderer>();
                        count++;
                    }
                }
            }
